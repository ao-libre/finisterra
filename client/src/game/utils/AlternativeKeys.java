...
public class AlternativeKeysTwo {

    public static final int ATTACK_1 = Input.Keys.SHIFT_LEFT;
    public static final int ATTACK_2 = Input.Keys.Space;
    public static final int MEDITATE = Input.Keys.X;
    public static final int USE = Input.Keys.F;
    public static final int HIDE = Input.Keys.C;
    public static final int INVENTORY = Input.Keys.I;
    public static final int SPELLS = Input.Keys.K;
    public static final int TALK = Input.Keys.ENTER;
    public static final int DROP = Input.Keys.T;

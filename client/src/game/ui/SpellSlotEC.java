...
public class SpellSlotEC extends ImageButton {
    ...
    private final EchisosCompletos echisosCompletos;
    private final ClickListener clickListener;
    private Spell spell;
    private Texture icon;
    private Tooltip tooltip;

    SpellSlotEC(EchisosCompletos echisosCompletos, Spell spell) {
        super(Skins.COMODORE_SKIN, "icon-container");
        this.echisosCompletos = echisosCompletos;
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        drawSpell(batch);
        echisosCompletos.selected.filter(sp -> sp.equals(spell)).ifPresent(sp -> drawSelection(batch));
    }
    ...
    private void onClick() {
        echisosCompletos.selected(spell);
    }

...
public class MusicHandler extends PassiveSystem {
    ...
    public void playMusic(int musicID) {
        ...
        if (music == null) {
            Log.error(SoundsHandler.class.getSimpleName(), "Error: tried to play music index: " + musicID + ", but it was not loaded.");
            return;
        }
    ...
    public void stopMusic(int musicID) {
        Music music = assetManager.getMusic(musicID);
        if (music == null) {
            Log.error(SoundsHandler.class.getSimpleName(), "Error: tried to stop music index: " + musicID + ", but it was not loaded.");
            return;
        }
        music.stop();
    }
    ...
    public void fadeInMusic(int musicID, float fadeRate) {
        Timer.schedule(new Timer.Task() {
            ...
            public void run() {
                Music music = assetManager.getMusic(musicID);
                if (music == null) {
                    Log.error(SoundsHandler.class.getSimpleName(), "Error: tried to stop music index: " + musicID + ", but it was not playing or loaded.");
                    return;
                }
    ...
    public void playMIDI(int midiID) {
        ...
        if (sequencer == null) {
            Log.error(SoundsHandler.class.getSimpleName(), "Error: tried to play midi index: " + midiID + ", but it was not loaded.");
            return;
        }

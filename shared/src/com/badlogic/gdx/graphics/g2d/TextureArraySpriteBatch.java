 ...
 * <p>
 * Use this Batch if you frequently utilize more than a single texture between calling {@link this#begin()} and {@link this#end()}. An
...
public class TextureArraySpriteBatch implements Batch {
    ...
    /**
     * The current number of textures in the LFU cache. Gets reset when calling {@link this#begin()}
     **/
    private int currentTextureLFUSize = 0;

    /**
     * The current number of texture swaps in the LFU cache. Gets reset when calling {@link this#begin()}
     **/
    ...
    public TextureArraySpriteBatch(int size, ShaderProgram defaultShader) {
        ...
        if (defaultShader == null) {
            ...
            if (maxTextureUnits == 0) {
                throw new IllegalStateException("Texture Arrays is not supported on this device.");
            }

...
abstract class DescriptorEditor extends Dialog {
    ...
    public Table getTable(Descriptor descriptor) {
        ...
        table.add(IntegerEditor.create("West", FieldProvider.ANIMATION, b -> descriptor.getIndexs()[Constants.Heading.WEST.toInt()] = b, () -> descriptor.getGraphic(Constants.Heading.WEST.toInt()))).row();
        table.add(IntegerEditor.create("North", FieldProvider.ANIMATION, b -> descriptor.getIndexs()[Constants.Heading.NORTH.toInt()] = b, () -> descriptor.getGraphic(Constants.Heading.NORTH.toInt()))).row();
